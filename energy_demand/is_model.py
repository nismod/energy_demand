...
class IndustryModel(object):
    ...
    def create_enduse(self, region_obj, data, crit_flat_profile):
        ...
        industry_object = endusefunctions.Enduse(
            ...
            tech_increased_service=data['assumptions']['is_tech_increased_service'][self.enduse],
            tech_decreased_share=data['assumptions']['is_tech_decreased_share'][self.enduse],
            tech_constant_share=data['assumptions']['is_tech_constant_share'][self.enduse],
