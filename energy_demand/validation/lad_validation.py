...
def temporal_validation(local_paths, lookups, ed_fueltype_national_yh):
    ...
    diff_factor_TD_ECUK_Input = (1.0 / np.sum(val_elec_data_2015_INDO)) * np.sum(ed_fueltype_national_yh[lookups['fueltype']['electricity']])
...
def tempo_spatial_validation(
    ...
    print(data['lookups']['fueltype']['electricity'])
    print("--")
    print(ed_fueltype_national_yh[data['lookups']['fueltype']['electricity']])
    print(val_elec_data_2015_INDO[peak_day])
    print(ed_fueltype_national_yh[data['lookups']['fueltype']['electricity']][peak_day])
