    ...
    def __init__(
        ...
        if np.sum(fuel) == 0:
            ...
            if self.enduse_techs == []:
                ...
                '''if enduse == 'rs_space_heating' and curr_yr > 2015:
                    logging.info(self.fuel_supply_generated)
                    logging.info(self.fuel_supply_generated.shape)
                    logging.info(curr_yr)
                    #prnt(":eg")'''
    ...
    if mode_constrained:
        for tech, service in service_tech.items():
            ...
            if tech_type == 'tech_CHP':
                ...
                logging.info("Elec in by: {}  elec in cy: {} total diff: {}  int: {} shape {}".format(
                    fuel_generated_by, fuel_generated_cy, additional_fuel_generated_cy, fueltype_generation_int, fuel_supply_generated.shape))

                # ---------------------------------------
                # TODO: NOT CORRECT DO NOT DO THIS TODO TODO TODO
                # --------
