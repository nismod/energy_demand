...
def load_script_data(base_data):
    """Load data generated by scripts
    """
    # Read in Services (from script data)
    base_data['assumptions']['rs_service_tech_by_p'] = read_service_data_service_tech_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'rs_service_tech_by_p.csv'))
    base_data['assumptions']['ss_service_tech_by_p'] = read_service_data_service_tech_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'ss_service_tech_by_p.csv'))
    base_data['assumptions']['is_service_tech_by_p'] = read_service_data_service_tech_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'is_service_tech_by_p.csv'))
    base_data['assumptions']['rs_service_fueltype_by_p'] = read_service_fueltype_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'rs_service_fueltype_by_p.csv'))
    base_data['assumptions']['ss_service_fueltype_by_p'] = read_service_fueltype_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'ss_service_fueltype_by_p.csv'))
    base_data['assumptions']['is_service_fueltype_by_p'] = read_service_fueltype_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'is_service_fueltype_by_p.csv'))
    base_data['assumptions']['rs_service_fueltype_tech_by_p'] = read_service_fueltype_tech_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'rs_service_fueltype_tech_by_p.csv'))
    base_data['assumptions']['ss_service_fueltype_tech_by_p'] = read_service_fueltype_tech_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'ss_service_fueltype_tech_by_p.csv'))
    base_data['assumptions']['is_service_fueltype_tech_by_p'] = read_service_fueltype_tech_by_p(os.path.join(base_data['path_dict']['path_scripts_data'], 'services', 'is_service_fueltype_tech_by_p.csv'))

    # Read technologies with more, less and constant service based on service switch assumptions (from script data)
    base_data['assumptions']['rs_tech_increased_service'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'rs_tech_increased_service.csv'))
    base_data['assumptions']['ss_tech_increased_service'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'ss_tech_increased_service.csv'))
    base_data['assumptions']['is_tech_increased_service'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'is_tech_increased_service.csv'))

    base_data['assumptions']['rs_tech_decreased_share'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'rs_tech_increased_service.csv'))
    base_data['assumptions']['ss_tech_decreased_share'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'ss_tech_increased_service.csv'))
    base_data['assumptions']['is_tech_decreased_share'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'is_tech_increased_service.csv'))

    base_data['assumptions']['rs_tech_constant_share'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'rs_tech_increased_service.csv'))
    base_data['assumptions']['ss_tech_constant_share'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'ss_tech_increased_service.csv'))
    base_data['assumptions']['is_tech_constant_share'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'is_tech_increased_service.csv'))

    # Read in sigmoid technology diffusion parameters (from script data)
    base_data['assumptions']['rs_sig_param_tech'] = read_sig_param_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'rs_sig_param_tech.csv'))
    base_data['assumptions']['ss_sig_param_tech'] = read_sig_param_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'ss_sig_param_tech.csv'))
    base_data['assumptions']['is_sig_param_tech'] = read_sig_param_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'is_sig_param_tech.csv'))

    # Read in installed technologies (from script data)
    base_data['assumptions']['rs_installed_tech'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'rs_installed_tech.csv'))
    base_data['assumptions']['ss_installed_tech'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'ss_installed_tech.csv'))
    base_data['assumptions']['is_installed_tech'] = read_installed_tech(os.path.join(base_data['path_dict']['path_scripts_data'], 'is_installed_tech.csv'))
