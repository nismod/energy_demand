...
def read_model_result_from_txt(fueltypes_lu, nr_of_fueltypes, path_to_folder):
    ...
    """
    result_array = {}
    np.zeros((nr_of_fueltypes, 365)) #WHALE
    ...
    for file_path in all_txt_files_in_folder:
        ...
        print("path_file_to_read: " + str(path_file_to_read))
        txt_data = np.loadtxt(path_file_to_read)
        
        #Year
        year = file_path_split[1]

        #Fueltype
        fueltype_str = file_path_split[2]
        fueltype_array_position = fueltypes_lu[fueltype_str]

        #Insert
        result_array[year][fueltype_array_position] = txt_data
