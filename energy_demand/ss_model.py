...
class ServiceModel(object):
    ...
    def create_enduse(self, region_obj, data):
        ...
        enduse_object = endusefunctions.Enduse(
            ...
            tech_increased_service=data['assumptions']['ss_tech_increased_service'][self.enduse],
            tech_decreased_share=data['assumptions']['ss_tech_decreased_share'][self.enduse],
            tech_constant_share=data['assumptions']['ss_tech_constant_share'][self.enduse],
