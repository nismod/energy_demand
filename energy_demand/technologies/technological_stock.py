...
class TechStock(object):
    ...
    def get_tech_attr(self, enduse, tech_name, attribute_to_get):
        ...
        if attribute_to_get == 'tech_fueltype_str':
            attribute_value = tech_object.tech_fueltype_str
        ...
        for technology_name in enduse_technologies[enduse]:
            ...
            if tech_type == 'dummy_tech':
                ...
                tech_obj = Technology(
                    technology_name,
                    tech_type,
                    technologies[technology_name].fuel_type_str, #¨TODO: CLENA TO tech_fueltype_str
...
class Technology(object):
    ...
    def __init__(
        ...
        if tech_name == 'dummy_tech':
            ...
            self.tech_name = tech_name
            self.tech_type = tech_type
            self.tech_fueltype_str = tech_fueltype
            self.tech_fueltype_int = tech_related.get_fueltype_int(lu_fueltypes, tech_fueltype)
