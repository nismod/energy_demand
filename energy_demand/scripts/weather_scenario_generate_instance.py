...
path_out_stations = "X:/nismod/data/energy_demand/H-Met_office_weather_data/_complete_meteo_data_all_yrs_cleaned_min_max/_NEWFILE.csv"

create_annual_weather_file(
    path,
    path_out_stations,
    year=2015,
