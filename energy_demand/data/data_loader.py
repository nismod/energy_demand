...
from energy_demand.data import rs_read_data
...
def load_data(path_main, data):
    ...
    for sector in data['ss_fuel_raw_data_enduses']:
        for enduse in data['ss_fuel_raw_data_enduses'][sector]:
            testsum += data['ss_fuel_raw_data_enduses'][sector][enduse][2]
    print("GAS0 : " + str(testsum))
