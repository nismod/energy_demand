...
def main(
    ...
    # Create mluti sim folder result
    basic_functions.del_previous_setup(path_multiple_simulations)
    basic_functions.create_folder(path_multiple_simulations)
    ...
    for scenarios_path in scenarios_paths:
        ...
        for simulation_yr_to_plot in simulation_yrs_to_plot:
            ...
            for scenario_nr, scenario_name in enumerate(all_scenarios):
                ...
                x_chart_yrs_storage[simulation_yr_to_plot][scenario_name] = result_entry2
        ...
        ## ------------------------------
        ## Plotting x-chart for every simulation
        ## ------------------------------
    ...
    # -------------
    # Multi-simulation plots to compare weather 2020 and weather IPC TODO: NEW
    # -------------
