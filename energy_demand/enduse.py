...
class Enduse(object):
    ...
    def __init__(self, region_name, data, enduse, sector, enduse_fuel, tech_stock, heating_factor_y, cooling_factor_y, fuel_switches, service_switches, fuel_enduse_tech_p_by, tech_increased_service, tech_decreased_share, tech_constant_share, installed_tech, sig_param_tech, enduse_overall_change_ey, load_profiles, dw_stock=False, reg_scenario_drivers={}):
        ...
        self.base_yr = data['base_sim_param']['base_yr']
        self.end_yr = data['base_sim_param']['end_yr']
        ...
        if np.sum(enduse_fuel) == 0: # Enduse has no fuel. Create empty shapes
            ...
            crit_switch_fuel = self.get_crit_switch_fuel(fuel_switches)
            ...
            self.enduse_fuel_yd = self.calc_fuel_tech_yd(enduse_fuel_tech_y, tech_stock, load_profiles)
            ...
            self.enduse_fuel_peak_h = self.calk_peak_h_dh()
    ...
    def get_peak_fuel_day(self, enduse_fuel_yh):
        ...
        # Sum within day and get day with maximum sum day
    ...
    def service_switch(self, tot_service_h_cy, service_tech_by_p, tech_increase_service, tech_decrease_service, tech_constant_service, sig_param_tech):
    ...
    def calc_fuel_tech_yd(self, enduse_fuel_tech, tech_stock, load_profiles):
        ...
        for tech in self.technologies_enduse:
            ...
            fueltype_tech_share_yd_24 = tech_stock.get_tech_attr(self.enduse, tech, 'fuel_per_type_yd')

            fueltype_tech_share_yd = np.sum(fueltype_tech_share_yd_24, axis=1) #NEW
            ...
            for fueltype, fuel_shares_dh in enumerate(fueltype_tech_share_yd): #SPEED IMPROVE
                ...
                share_of_fuel = average_fuel_share_in_year * fuel_shares_dh #share_of_fuel = (1.0 / 8760) * fuel_shares_dh #NEW
    ...
    def calc_fuel_tech_yh(self, enduse_fuel_tech, tech_stock, load_profiles):
        ...
        for tech in self.technologies_enduse:
            ...
            fueltypes_tech_share_yh_24 = np.sum(fueltypes_tech_share_yh, axis=1) #NEW
            ...
            for fueltype, fuel_tech_share in enumerate(fueltypes_tech_share_yh):
                try: #SPEED
                    ...
                    share_of_fuel = average_fuel_share_in_year * fuel_tech_share
    ...
    def fuel_switch(self, installed_tech, sig_param_tech, tot_service_h_cy, service_tech, service_fueltype_tech_cy_p, service_fueltype_cy_p, fuel_switches, fuel_enduse_tech_p_by):
